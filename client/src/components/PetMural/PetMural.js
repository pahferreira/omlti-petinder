...
export default class PetMural extends React.Component {
    ...
    render() {
        ...
        let result = <Grid container xs={10} sm={9} alignItems={'center'} direction={'column'} > 
            <Grid container item alignItems={'center'} >
            { this.state.loading ? <Grid item xs={8} sm={3} > <img src='https://cdn.dribbble.com/users/172519/screenshots/3520576/dribbble-spinner-800x600.gif'/> </Grid> 
            : this.state.pets.map(pet => <Grid item xs={8} sm={3}><PetAvatar name={pet.nome} img={pet.fotos} /></Grid>)}
            </Grid>
            <Grid item > 
